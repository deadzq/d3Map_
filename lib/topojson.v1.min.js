    ...
    function(n, t) {
        ...
        function a(n, t) {
            ...
            return t.forEach(function(r, e) {
                ...
                else if (t = i[c]) if (delete i[t.start], t.unshift(n), t.start = f, e = u[f]) {
                    delete u[e.end];
        ...
        function l(n, t, r) {
            ...
            if (arguments.length > 1) {
                ...
                u(t), s.forEach(arguments.length < 3 ?
                    function(n) {
                        f.push(n[0].i)
                    } : function(n) {
                        r(n[0].g, n[n.length - 1].g) && f.push(n[0].i)
                    })
            } else for (var h = 0, p = n.arcs.length; p > h; ++h) f.push(h);
            return {
        ...
        function g(n, t) {
            ...
            return t.forEach(function(n) {
                ...
                arcs: u.map(function(t) {
                    ...
                    }), i = a(n, i), (r = i.length) > 1) for (var u, f, c = 1, s = e(i[0]); r > c; ++c)(u = e(i[c])) > s && (f = i[0], i[0] = i[c], i[c] = f, s = u);
                    return i
                })
            }
        }
        function y(n) {
            ...
            n.forEach(e);
            for (var c in o) for (var a = o[c], s = a.length, l = 0; s > l; ++l) for (var h = l + 1; s > h; ++h) {
                var p, v = a[l],
                    g = a[h];
